...
resume_videos = [['How to Write a Resume For Freshers & Experienced','https://youtu.be/y8YH0Qbu5h4'],
                 ['FREE Resume Building Websites  Get Resume Templates','https://youtu.be/J-4Fv8nq1iA'],
                 ['Resume for freshers created using MS WORD','https://youtu.be/yp693O87GmM'],
                 ['Free Resume making Websites','https://youtu.be/UeMmCex9uTU'],
                 ['Resume Tips for Jobs and Internships','https://youtu.be/dQ7Q8ZdnuN0'],
                 ['Resume Tips For Freshers  How To Write A Resume ?','https://youtu.be/HQqqQx5BCFY'],
                 ['Make the perfect resume','https://youtu.be/CLUsplI4xMU'],
                 [' Software Engineer Resume Tips For Freshers & Experienced','https://youtu.be/pbczsLkv7Cc']]

interview_videos = [['8 Most-Asked Interview Questions & Answers','https://youtu.be/Ji46s5BHdr0'],
                    ['Fresher? Then must watch for you!  Interview Tips for Freshers','https://youtu.be/seVxXHi2YMs'],
                    ['11 Interview Questions And Answers For Freshers, With Tips, HR View & Common Mistakes','https://youtu.be/9FgfsLa_SmY'],
                    ['Interview Tips for Freshers','https://youtu.be/2HQmjLu-6RQ'],
                    ['How to Prepare for Interviews  Best Interview Preparation Strategy','https://youtu.be/DQd_AlIvHUw'],
                    ['Interview for IT Company like Tata consultancy services','https://youtu.be/oVVdezJ0e7w'],
                    ['How to Introduce Yourself?','https://youtu.be/JZK1MZwUyUU'],
                    ['Interview Question: Why Should We Hire You?','https://youtu.be/CyXLhHQS3KY']]